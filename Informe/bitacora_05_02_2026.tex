...
\begin{itemize}
    ...
    \item Funciones para evaluar condiciones de alarma (absolutas, relativas a setpoints, `multiple\_and`).
...
Un script de prueba básico que demuestra la funcionalidad de `core\_logic.py`.
\begin{itemize}
