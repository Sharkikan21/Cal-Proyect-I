{
    ...
    "2270-ZM-009-14A/B": {
        ...
        "condiciones": [
            ...
            },
            {
                    "tipo": "custom_eval",
                    "condicion": {
                        "tag": "PNEUMATIC_GATE_VALVE",
                        "origen": "logica",  
                        "operador": "==",
                        "valor_esperado": "CLOSED"
                    },
                "tipo_alarma": "INTERLOCK",
                "descripcion": "Se puede iniciar válvula rotatoria del silo de cal.",
                "nombre_equipo": "LIME SILO ROTATORY VALVE - Interlock de activación"
        ...
        "condiciones": [
            {
                    "tipo": "custom_eval",
                    "condicion": {
                        "tag": "LIME_SILO_ROTARY_VALVE",
                        "origen": "logica",  
                        "operador": "==",
                        "valor_esperado": "STOPPED"
                    },
                "tipo_alarma": "INTERLOCK",
    ...
    "2270-ZV-11852": {
        ...
        "condiciones": [
            ...
            },
            {
                    "tipo": "custom_eval",
                    "condicion": {
                        "tag": "STATE_2270-HS-11810",
                        "origen": "logica",  
                        "operador": "==",
                        "valor_esperado": "ENABLED_FROM_DCS"
                    },
                "tipo_alarma": "INTERLOCK",
                "descripcion": "Permite iniciar ventilador de escape de cal.",
                "nombre_equipo": "LIME SCRUBBER EXHAUST FAN"
        ...
        "condiciones": [
            {
                    "tipo": "custom_eval",
                    "condicion": {
                        "tag": "SCRUBBER_FAN_2270-ZM-009-20",
                        "origen": "logica",  
                        "operador": "==",
                        "valor_esperado": "OPERATING"
                    },
                "tipo_alarma": "INTERLOCK",
            ...
            },
            {
                    "tipo": "custom_eval",
                    "condicion": {
                        "tag": "SCREW_FEEDER_2270-ZM-009-04",
                        "origen": "logica",  
                        "operador": "==",
                        "valor_esperado": "OPERATING"
                    },
    ...
    "2270-TIC-11801": {
        ...
        "condiciones": [
            {
            "tipo": "relacion_control",
            "condicion": {
                "tag_controlador": "2270-TIC-11801",
                "controla": [
                {
                    "actuador": "2270-TV-11801",
                    "accion_esperada": "OPEN"
                },
                {
                    "actuador": "2270-HV-11808",
                    "accion_esperada": "OPEN"
                }
                ]
            },
        ...
        "condiciones": [
            {
                "tipo": "custom_eval",
                "condicion": {
                    "tag": "TIEMPO_OPERACION_AGITADOR",
                    "origen": "logica",
                    "operador": ">=",
                    "valor_esperado": "2 minutos"
                },
                "tipo_alarma": "INTERLOCK",
        ...
        "condiciones": [
            {
                  "tipo": "custom_eval",
                    "condicion": {
                        "tag": "VALVULA_SOLENOIDE_2270-ZV-11880",
                        "origen": "logica",
                        "operador": "==",
                        "valor_esperado": "OPEN"
                    },
        ...
        "condiciones": [
            {
                ...
                "tipo_alarma": "INTERLOCK",
                "descripcion": "Permite iniciar bomba de transferencia si LALL-11850 está presente.",
                "nombre_equipo": "LIME TRANSFER PUMP"
            }
        ]
    }
