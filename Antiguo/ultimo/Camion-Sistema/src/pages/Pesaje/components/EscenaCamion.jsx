// Nueva ruta: src/pages/Pesaje/components/EscenaCamion.jsx
...
function EscenaCamion({
    ...
    // Efecto para controlar la cámara
    useEffect(() => {
    ...
    // Efecto para controlar las animaciones
    useEffect(() => {
    ...
    // Efecto para asegurar que los materiales tengan sombra y se vean bien
    useEffect(() => {
